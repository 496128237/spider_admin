<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/Applications/MAMP/htdocs/spider_admin/application/admin/view/spider/index.html";i:1531206323;s:73:"/Applications/MAMP/htdocs/spider_admin/application/admin/view/layout.html";i:1531194763;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
    <head>
        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="<?php echo input('id')?'edit':'add'; ?>" method="post" name="myfrom" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" value="<?php echo (isset($info['name']) && ($info['name'] !== '')?$info['name']:''); ?>" name="name" placeholder="name"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="link" placeholder="link" value="<?php echo (isset($info['link']) && ($info['link'] !== '')?$info['link']:''); ?>" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="space-4"></div>

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">提示</label>
                    <div class="col-sm-9">
                        <textarea name="tip" class="col-xs-10 col-sm-5" placeholder="tip"><?php echo (isset($info['tip']) && ($info['tip'] !== '')?$info['tip']:''); ?></textarea>
                    </div>
                </div>
                <div class="space-4"></div>

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 数据库ip </label>

                    <div class="col-sm-9">
                        <input type="text" name="sql_ip" placeholder="sql_ip" value="<?php echo (isset($info['sql_ip']) && ($info['sql_ip'] !== '')?$info['sql_ip']:''); ?>" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="space-4"></div>

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 数据库用户名 </label>

                    <div class="col-sm-9">
                        <input type="text" name="sql_user" placeholder="sql_user" value="<?php echo (isset($info['sql_user']) && ($info['sql_user'] !== '')?$info['sql_user']:''); ?>" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="space-4"></div>

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 数据库密码 </label>

                    <div class="col-sm-9">
                        <input type="text" name="sql_pass" placeholder="sql_pass" value="<?php echo (isset($info['sql_pass']) && ($info['sql_pass'] !== '')?$info['sql_pass']:''); ?>" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="space-4"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="sql_database" placeholder="sql_database" value="<?php echo (isset($info['sql_database']) && ($info['sql_database'] !== '')?$info['sql_database']:''); ?>" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="space-4"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="sql_table" placeholder="sql_table" value="<?php echo (isset($info['sql_table']) && ($info['sql_table'] !== '')?$info['sql_table']:''); ?>" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="space-4"></div>
