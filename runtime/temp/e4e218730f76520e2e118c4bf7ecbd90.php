<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/Applications/MAMP/htdocs/spider_admin/application/admin/view/spider/info.html";i:1531302384;s:73:"/Applications/MAMP/htdocs/spider_admin/application/admin/view/layout.html";i:1531194763;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
    <head>
    ...
    <div class="col-sm-6 pull-right">
        <button class="btn btn-sm btn-primary pull-right" onclick="javascript:window.location.href = '<?php echo url('site/index'); ?>'">
            返回列表
        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="<?php echo input('id')?'edit':'add'; ?>" method="post" name="myfrom" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" value="<?php echo (isset($info['name']) && ($info['name'] !== '')?$info['name']:''); ?>" name="name" placeholder="name" disabled/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 站点链接 </label>

                    <div class="col-sm-9">
                        <input type="text" name="link" placeholder="link" value="<?php echo (isset($info['link']) && ($info['link'] !== '')?$info['link']:''); ?>" class="col-xs-10 col-sm-5" disabled />
                    </div>
                </div>
                <div class="space-4"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="sql_database" placeholder="sql_database" value="<?php echo (isset($info['sql_database']) && ($info['sql_database'] !== '')?$info['sql_database']:''); ?>" class="col-xs-10 col-sm-5" disabled />
                    </div>
                </div>
                <div class="space-4"></div>

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 入库表 </label>

                    <div class="col-sm-9">
                        <input type="text" name="sql_table" placeholder="sql_table" value="<?php echo (isset($info['sql_table']) && ($info['sql_table'] !== '')?$info['sql_table']:''); ?>" class="col-xs-10 col-sm-5" disabled />
                    </div>
                </div>
                <div class="space-4"></div>

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 采集规则 </label>

                    <div class="col-sm-9">
                        <select class="form-control" name="spider_rex" style="width: 325px;">
                            <option value="">请选择采集规则</option>
                            <?php if(is_array($reginfo) || $reginfo instanceof \think\Collection || $reginfo instanceof \think\Paginator): $i = 0; $__LIST__ = $reginfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 采集地址 </label>

                    <div class="col-sm-9">
                        <input type="text" name="spider_url" placeholder="采集地址" value="" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="space-4"></div>

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 采集分类 </label>

                    <div class="col-sm-9">
                        <input type="text" name="spider_classid" placeholder="采集分类" value="" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="space-4"></div>

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 采集数量 </label>

                    <div class="col-sm-9">
                        <input type="text" name="spider_num" placeholder="采集数量" value="" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                <div class="space-4"></div>
