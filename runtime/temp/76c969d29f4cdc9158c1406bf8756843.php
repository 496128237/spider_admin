<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/Applications/MAMP/htdocs/spider_admin/application/admin/view/regulation/index.html";i:1531290551;s:73:"/Applications/MAMP/htdocs/spider_admin/application/admin/view/layout.html";i:1531194763;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
    <head>
                    ...
                    <table id="simple-table" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href='<?php echo url("info","id=$vo[id]"); ?>'><?php echo $vo['name']; ?></a></td>
