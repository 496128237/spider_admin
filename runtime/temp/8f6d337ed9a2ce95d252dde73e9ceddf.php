<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/Applications/MAMP/htdocs/spider_admin/application/admin/view/regulation/info.html";i:1531289380;s:73:"/Applications/MAMP/htdocs/spider_admin/application/admin/view/layout.html";i:1531194763;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
    <head>
        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="<?php echo input('id')?'edit':'add'; ?>" method="post" name="myfrom" >
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">规则名称</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 匹配列表规则 </label>

                    <div class="col-sm-9">
                        <textarea name="reg_list" class="col-xs-10 col-sm-5" placeholder="reg_list"><?php echo (isset($info['reg_list']) && ($info['reg_list'] !== '')?$info['reg_list']:''); ?></textarea>
                    </div>
                </div>
                <div class="space-4"></div>

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 匹配title规则 </label>

                    <div class="col-sm-9">
                        <textarea name="reg_title" class="col-xs-10 col-sm-5" placeholder="reg_title"><?php echo (isset($info['reg_title']) && ($info['reg_title'] !== '')?$info['reg_title']:''); ?></textarea>
                    </div>
                </div>
                <div class="space-4"></div>

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 匹配dec规则 </label>

                    <div class="col-sm-9">
                        <textarea name="reg_dec" class="col-xs-10 col-sm-5" placeholder="reg_dec"><?php echo (isset($info['reg_dec']) && ($info['reg_dec'] !== '')?$info['reg_dec']:''); ?></textarea>
                    </div>
                </div>
                <div class="space-4"></div>

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 匹配content规则 </label>

                    <div class="col-sm-9">
                        <textarea name="reg_content" class="col-xs-10 col-sm-5" placeholder="reg_content"><?php echo (isset($info['reg_content']) && ($info['reg_content'] !== '')?$info['reg_content']:''); ?></textarea>
                    </div>
                </div>
                <div class="space-4"></div>
